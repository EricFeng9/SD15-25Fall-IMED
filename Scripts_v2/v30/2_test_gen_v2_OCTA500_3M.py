...
--------------------------------------
功能：
1. 遍历 OCTA500/3M/GroundTruth 数据目录下的 test/train/valid 子文件夹
2. 读取子文件夹中的血管分割图 (*.bmp)
...
# OCTA500 3M 数据目录
DEFAULT_DATA_ROOT = "/data/student/Fengjunming/diffusion_registration/SDXL_ControlNet/data/OCTA500/3M"
...
def main():
    parser = argparse.ArgumentParser(description="OCTA500_3M 生成推理脚本")
    # mode: 要生成的目标类型
    # - fa: 目标图是 FA (荧光血管造影)
    # - cf: 目标图是 CF (彩色眼底照)
