...
def visualize_random_cf(unet, vae, tokenizer, text_encoder, uncond_embeds,
                        num_samples: int, out_dir: str, steps: int = 50, cfg_scale: float = 7.5):
    """
...
def main():
    ...
    parser.add_argument("--cfg_scale", type=float, default=7.5, help="可视化时使用的 Classifier-Free Guidance scale，推荐 7.5")
