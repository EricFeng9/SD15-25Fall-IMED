...
def main():
    ...
    # 【v23 新增】在 CF-FA 模式下对 UNet 启用 Shared Self-Attention
    if is_cf_fa_mode:
        # PeftModel 中的真正 UNet 位于 base_model
        ...
        print("✓ Shared Self-Attention 已应用到 UNet（仅 Self-Attention 层生效）")
    ...
    while global_step < args.max_steps:
        for batch in train_loader:
            ...
            # 每 500 步验证 & 早停判断（可近似视为“每若干 epoch”）
            if global_step % 500 == 0:
                # Shared Self-Attention 模式下使用简化验证：仅基于联合噪声 MSE
                val_loss = evaluate_shared_self_attn(
