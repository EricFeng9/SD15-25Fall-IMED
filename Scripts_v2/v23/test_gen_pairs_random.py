...
用法示例：
    ...
    python Scripts_v2/v23/test_gen_pairs_random.py \\
        --ckpt_dir /data/student/Fengjunming/SDXL_ControlNet/results/out_ctrl_sd15_dual/cf2fa/exp_v23/best_checkpoint \\
        --num_samples 5

说明：
- 加载 SD15 基础模型 + 训练好的 UNet LoRA（来自 v23/train.py 保存的 unet_lora）；
- 对每个样本：
  - 采样一份高斯噪声 latent z_T；
