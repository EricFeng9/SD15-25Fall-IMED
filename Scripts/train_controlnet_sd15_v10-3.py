# -*- coding: utf-8 -*-
'''
训练脚本 - SD 1.5 + Dual ControlNet 版本 v10-3
...
def main():
    ...
    parser.add_argument("--max_steps", type=int, default=13000,
                        help="总训练步数")
    ...
    validate_every = 500
    early_stopped = False
    min_train_steps = 3000  # v10-3: Warm-up期，前3000步不触发早停
    ...
    # ============ 训练信息打印 ============
    print("\n" + "="*70)
    print("【SD 1.5 + Dual ControlNet 训练配置 v10-3】✨ 🎯")
    print("="*70)
    ...
    print(f"\n  【训练配置】")
    print(f"  ├─ 模型版本: SD 1.5 + Dual ControlNet v10-3 (Scribble + Tile, FP32)")
    print(f"  ├─ 数据集类型: {'CF-FA' if is_cffa else ('CF_OCT' if is_cfoct else 'CF-OCTA')}")
