...
【使用方法】
训练: python train_controlnet_sd15_v5-2.py --mode cf2octa --name sd15_v5-2 --max_steps 8000
恢复: python train_controlnet_sd15_v5-2.py --mode cf2octa --name sd15_v5-2 --resume_from /path/to/step_6000
    ...
    try:
        ...
        if affine_path and os.path.exists(affine_path):
            ...
            if args.mode == "octa2cf":
                ...
                # OCTA图配准保持原始尺寸
                octa_size = (target_img_preprocessed.width, target_img_preprocessed.height)
